  ...
  return (
    <div className="bg-brand-color">
      <div className="container mx-auto h-11 flex items-center justify-between">
        ...
        <nav>
          <ul className="flex gap-x-8 items-center justify-between">
            <li>
              <a
                href="#"
                className="flex gap-x-2 items-center text-white text-white text-sm opacity-70 hover:opacity-100 transition-all"
              >
                <BiGlobe size={20} />
                <span>Türkçe (TR)</span>
              </a>
